...
pub fn draw(frame: &mut Frame) {
    ...
    let lines = vec![
        ...
        binding("Ctrl+Shift+E", "Manage environments (from Variables overlay)"),
        ...
        Line::raw(""),
        header("Projects"),
        binding("F6", "Next project"),
        binding("F7", "Previous project"),
        binding("Ctrl+O", "Open project picker"),
        binding("d  (in picker)", "Close project"),
        Line::raw(""),
        header("View & Display"),
        binding(
            "Ctrl+1 / 2 / 3",
